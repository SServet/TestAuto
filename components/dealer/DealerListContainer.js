...
export default function DealerListContainer() {
  ...
  return (
    ...
    <div className="">
      <div className="w-10/12 lg:w-11/12 md:!w-full mx-auto lg:px-6 lg:pt-0 px-20 bg-white pt-6">
      ...
      <div className="w-10/12 lg:w-11/12 md:!w-full md:p-4 mx-auto bg-white pt-4">
          <DealerListCard />
          <DealerListCard />
          <DealerListCard />
          <DealerListCard />
