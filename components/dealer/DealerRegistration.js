  ...
  return (
    <div className="bg-theme-gray-3 overflow-hidden lg:px-6 md:!px-0">
      <div className="relative w-10/12 lg:w-full max-w-ag-container md:!w-full mx-auto flex lg:flex-col bg-white p-4">
        <div className="w-1/2 relative lg:w-full mr-2 rounded-md bg-theme-gray-4 flex flex-col text-theme-black-2 text-15 md:text-xs lg:flex-col p-6">
          <Link href="/">
          ...
          <div className="flex items-center mt-6">
            <p className="text-gray-500 text-xl font-bold pr-4">Firma</p>
