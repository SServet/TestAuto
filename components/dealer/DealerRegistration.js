...
export default function DealerRegistration() {
  ...
  return (
    <div className="bg-theme-gray-3 overflow-hidden lg:px-6 md:!px-0">
      <div className="relative w-10/12 max-w-ag-container lg:flex-col lg:w-full mx-auto flex items-center bg-user-input">
        <div className="w-1/2 md:!w-full lg:w-2/3 lg:mx-auto px-6 py-8 lg:pt-16">
          <Link href="/">
            <a className="absolute left-6 top-2 flex items-center text-black text-sm font-semibold opacity-60">
          ...
          <div className="mt-4">
            <div>
              <div className="flex items-center mb-2">
                ...
                <input className="w-7/12 border rounded text-md p-2 border-slate-300" />
              </div>
              <div className="flex items-center mb-2">
                <label className="w-5/12 text-right pr-4 text-sm font-bold inline-block">
                  Ergänzung
              ...
              <h3 className="w-7/12 ml-auto text-2xl font-bold mt-8 mb-4">
                Ansprechpartner
              </h3>
              <div className="flex items-center mb-2">
                <label className="w-5/12 text-right pr-4 text-sm font-bold inline-block">
              ...
              <div className="flex items-center mb-2">
                ...
                <input
                  className="w-7/12 border rounded text-md p-2 border-slate-300"
                  type="email"
                />
              </div>
              <div className="flex items-center mb-2">
              ...
              <div className="flex items-center mb-2">
                ...
                <input
                  className="w-3/12 border rounded text-md p-2 border-slate-300"
                  type="email"
                />
                <input
                  className="w-4/12 ml-2 flex-1 border rounded text-md p-2 border-slate-300"
                  type="email"
                />
              </div>
              <div className="flex items-center mb-2">
            ...
            <div className="flex justify-between items-end">
              <div className="w-7/12 ml-auto h-14 flex text-xs flex-col md:w-full justify-between pt-2">
                <div className="flex">
                  <input
