        ...
        <div className="rounded-md bg-theme-gray-4 p-4">
          <div className="border-b border-theme-gray-2 pb-4 mb-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-3xl font-bold text-theme-black-2">
                MEINE ENTWÜRFE
              </h2>
              {cards ? (
            ...
            <div className="flex items-end justify-between text-xs">
              <div className="flex items-center">
                ...
                <h2 className="text-50 font-bold text-theme-black-2">
                  {cards ? cards : 0}
                </h2>
              </div>
              {cards ? (
          ...
          {cards ? (
            ...
            <div className="mt-6 mx-4 pb-12">
              <div className="flex items-center justify-between text-xl p-6 rounded-md text-white font-bold bg-theme-gray-6">
                ...
                <button className="px-4 py-2 border rounded-md border-white">
                  INSERAT AUFGEBEN
                </button>
              </div>
              <p className="text-15 font-bold text-center mt-10 text-theme-black-2">
                WERBEN SIE JETZT UND ERREICHEN SIE MILLIONEN VON KÄUFERN!
              </p>
            </div>
          )}
        </div>
