...
export default function OverviewSchedule() {
  return (
    <div className="">
      <div className="flex lg:flex-wrap w-full items-start">
        <div className="w-64 lg:w-full mr-6 lg:mr-0 lg:mb-6 rounded-md py-3 px-2 text-theme-black-2 bg-theme-gray-4">
        ...
        <div className="flex flex-col lg:w-full">
          <div className="flex justify-between md:flex-col mb-6 lg:mb-4 lg:w-ful">
            ...
            <div className="w-64 flex lg:w-72 md:!w-full p-4 rounded-md text-theme-black-2 bg-theme-gray-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="60"
                height="60"
          ...
          <div className="flex lg:justify-between md:flex-col">
            ...
            <div className="w-64 lg:w-72 md:!w-full flex p-4 rounded-md text-theme-black-2 bg-theme-gray-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="60"
                height="60"
