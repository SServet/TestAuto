      ...
      <div className="flex-1">
        <div className="rounded-md bg-theme-gray-4 p-4">
          <div className="mb-2 text-theme-black-2">
            ...
            <p className="text-xs">
              Erzielen Sie bis zu 10-mal mehr Aufrufe, indem Sie Ihre Anzeige
              mit einem GIGA POWER versehen!
            </p>
          </div>
        ...
        <div className="mt-8 rounded-md bg-theme-gray-4 p-4">
          ...
          <div className="flex md:flex-col">
            ...
            >
              <>
                <p>- TITELBILD + PROFILBILD</p>
                <p>- TEXT BEREICH + KONTAKTDATEN</p>
                <p className="font-bold">- GOOGLE MAP</p>
              </>
            </GigaCard>
            <div className="w-4 md:hidden"></div>
            <GigaCard
            ...
            >
              <>
                ...
                <p>- TEXT BEREICH + KONTAKTDATEN</p>
                <p className="font-bold">- GOOGLE MAP</p>
                <p className="font-bold">- SOCIAL MEDIA + SHORT LINKS</p>
              </>
            </GigaCard>
            <div className="w-4 md:hidden"></div>
            <GigaCard
