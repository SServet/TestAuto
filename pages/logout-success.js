        ...
        <div className="relative w-10/12 lg:w-full max-w-ag-container md:!w-full mx-auto flex lg:flex-col bg-white p-4">
          <div className="w-1/2 lg:w-full mr-2 bg-theme-gray-4 rounded-md p-6 flex items-center justify-center flex-col text-theme-black-2 text-15 md:text-xs text-center lg:flex-col">
            <svg
              ...
              width="86.898"
              height="84.3"
              viewBox="0 0 86.898 84.3"
            >
              <path
                id="logout_FILL0_wght400_GRAD200_opsz40"
                d="M34.285,41.748H72.253L60.16,29.658l6.894-6.78L90.9,46.722,67.279,70.338l-7.005-6.894,12.2-12.2H34.285Zm12.09-37.29V13.95H13.492V79.266H46.375v9.492H13.492a9.112,9.112,0,0,1-6.666-2.826A9.118,9.118,0,0,1,4,79.266V13.95A9.118,9.118,0,0,1,6.826,7.284a9.112,9.112,0,0,1,6.666-2.826Z"
                transform="translate(-4 -4.458)"
                fill="#555"
              />
            </svg>
          ...
          <img className="w-1/2 lg:w-auto lg:ml-0 lg:mt-4 ml-2" src="/images/logout-success.png" />
        </div>
      </div>
      <Footer />
    </div>
